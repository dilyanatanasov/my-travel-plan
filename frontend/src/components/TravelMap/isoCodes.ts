 ...
 *
 * world-atlas TopoJSON identifies countries by numeric code, while our
 * countries table keys on alpha-3. Extracted from TravelMap so the public
 * shared map can render the same geography without copying 250 lines.
 */
