        ...
        <div className="px-3 sm:px-4 lg:px-6 h-14 sm:h-16 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            */}
            ...
            {/* Settings also lives in the account menu; the always-visible
                gear exists because user testing showed nobody looks in an
                avatar dropdown for it. */}
            <Link
              to="/settings"
              aria-label="Settings"
              title="Settings"
              className="flex items-center justify-center w-11 h-11 rounded-lg border border-line
